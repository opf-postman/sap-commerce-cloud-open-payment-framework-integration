...
| authentication_inbound_basic_auth_username                                           | ``username``, your web service username created for Adyen webhook, see [Configure webhooks in your Balance Platform Customer Area](https://docs.adyen.com/issuing/set-up-webhooks/#configure-customer-area) for detailed instructions.|                  
| authentication_inbound_basic_auth_password                                           | ``password``: the password that you created for Adyen webhook, see [Configure webhooks in your Balance Platform Customer Area](https://docs.adyen.com/issuing/set-up-webhooks/#configure-customer-area) for detailed instructions.|                  
